...
#include "drttypes.h"      // module-specific helper class
#include "seq/drtadcs.h"   // for AdmittingDiagnosesCodeSequence
#include "seq/drtbrs.h"    // for BreedRegistrationSequence
#include "seq/drtcdrs.h"   // for CalculatedDoseReferenceSequence
#include "seq/drtcsis.h"   // for CodingSchemeIdentificationSequence
#include "seq/drtcctus.h"  // for ConsentForClinicalTrialUseSequence
#include "seq/drtcpis.h"   // for ConsultingPhysicianIdentificationSequence
#include "seq/drtcgis.h"   // for ContextGroupIdentificationSequence
#include "seq/drtces.h"    // for ContributingEquipmentSequence
#include "seq/drtcsas.h"   // for ConversionSourceAttributesSequence
#include "seq/drtdimcs.h"  // for DeidentificationMethodCodeSequence
#include "seq/drtdcs.h"    // for DerivationCodeSequence
#include "seq/drtdss.h"    // for DigitalSignaturesSequence
#include "seq/drteas.h"    // for EncryptedAttributesSequence
#include "seq/drtfgss.h"   // for FractionGroupSummarySequence
#include "seq/drtgms.h"    // for GeneticModificationsSequence
#include "seq/drtgpis.h"   // for GroupOfPatientsIdentificationSequence
#include "seq/drthsdrs.h"  // for HL7StructuredDocumentReferenceSequence
#include "seq/drtians.h"   // for IssuerOfAccessionNumberSequence
#include "seq/drtiais.h"   // for IssuerOfAdmissionIDSequence
#include "seq/drtipiqs.h"  // for IssuerOfPatientIDQualifiersSequence
#include "seq/drtiseis.h"  // for IssuerOfServiceEpisodeIDSequence
#include "seq/drtmps.h"    // for MACParametersSequence
#include "seq/drtmris.h"   // for MappingResourceIdentificationSequence
#include "seq/drtmdrs.h"   // for MeasuredDoseReferenceSequence
#include "seq/drtois.h"    // for OperatorIdentificationSequence
#include "seq/drtoas.h"    // for OriginalAttributesSequence
#include "seq/drtopis.h"   // for OtherPatientIDsSequence
#include "seq/drtpbcs.h"   // for PatientBreedCodeSequence
#include "seq/drtpss.h"    // for PatientSetupSequence
#include "seq/drtpsics.h"  // for PatientSizeCodeSequence
#include "seq/drtpscs.h"   // for PatientSpeciesCodeSequence
#include "seq/drtppcs.h"   // for PerformedProtocolCodeSequence
#include "seq/drtporis.h"  // for PhysiciansOfRecordIdentificationSequence
#include "seq/drtprsis.h"  // for PhysiciansReadingStudyIdentificationSequence
#include "seq/drtpdecs.h"  // for PrivateDataElementCharacteristicsSequence
#include "seq/drtpcs.h"    // for ProcedureCodeSequence
#include "seq/drtrppcs.h"  // for ReasonForPerformedProcedureCodeSequence
#include "seq/drtrims.h"   // for ReferencedImageSequence
#include "seq/drtris.h"    // for ReferencedInstanceSequence
#include "seq/drtrpphs.h"  // for ReferencedPatientPhotoSequence
#include "seq/drtrps.h"    // for ReferencedPatientSequence
#include "seq/drtrppss.h"  // for ReferencedPerformedProcedureStepSequence
#include "seq/drtrrtps4.h" // for ReferencedRTPlanSequence
#include "seq/drtrsers.h"  // for ReferencedSeriesSequence
#include "seq/drtrss.h"    // for ReferencedStudySequence
#include "seq/drtrtrs4.h"  // for ReferencedTreatmentRecordSequence
#include "seq/drtrpis.h"   // for ReferringPhysicianIdentificationSequence
#include "seq/drtras.h"    // for RequestAttributesSequence
#include "seq/drtrscs.h"   // for RequestingServiceCodeSequence
#include "seq/drtsdcs.h"   // for SeriesDescriptionCodeSequence
#include "seq/drtsis.h"    // for SourceImageSequence
#include "seq/drtsins.h"   // for SourceInstanceSequence
#include "seq/drtspgis.h"  // for SourcePatientGroupIdentificationSequence
#include "seq/drtscs.h"    // for StrainCodeSequence
#include "seq/drtsss.h"    // for StrainStockSequence
#include "seq/drtscris.h"  // for StudiesContainingOtherReferencedInstancesSequence
#include "seq/drttms0.h"   // for TreatmentMachineSequence
#include "seq/drttsibs.h"  // for TreatmentSessionIonBeamSequence
#include "seq/drttscds.h"  // for TreatmentSummaryCalculatedDoseReferenceSequence
#include "seq/drttsmds.h"  // for TreatmentSummaryMeasuredDoseReferenceSequence
#include "seq/drtudis.h"   // for UDISequence
