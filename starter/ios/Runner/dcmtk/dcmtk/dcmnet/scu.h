...
#include "dctk.h"    /* covers most common dcmdata classes */
#include "dcasccff.h" /* for reading a association config file */
#include "dcasccfg.h" /* for holding association config file infos */
#include "dcompat.h"
#include "dimse.h" /* DIMSE network layer */
#include "oflist.h"
