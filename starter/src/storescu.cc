...
#include "dimse.h"
#include "diutil.h"
#include "dcmtrans.h"   /* for dcmSocketSend/ReceiveTimeout */
...
#include "tlsopt.h"     /* for DcmTLSOptions */
#include "ofstdinc.h"
#include <ctime>


#ifdef ON_THE_FLY_COMPRESSION
#include "djdecode.h"  /* for JPEG decoders */
#include "djencode.h"  /* for JPEG encoders */
#include "djdecode.h"  /* for JPEG-LS decoders */
#include "djencode.h"  /* for JPEG-LS encoders */
#include "dcrledrg.h"  /* for RLE decoder */
#include "dcrleerg.h"  /* for RLE encoder */
...
extern "C"
int mainStore(int argc, char *argv[])
{
...
extern "C"
int testSTORE(int argc, char *argv) {
